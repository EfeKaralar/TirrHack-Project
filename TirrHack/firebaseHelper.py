...
class FireBaseHelper():
    ...
    def get_stickynotes(self, key):
        return self.db.child("families").child(key).child("stickynotes").get()

    def delete_stickynote(self, key, note):
        self.db.child("families").child(key).child("stickynotes").child(note).remove()
    ...
    def delete_food_item(self, key, item):
        self.db.child("families").child(key).child("fooditems").child(item).remove()
    ...
    def delete_day(self, key, day):
        self.db.child("families").child(key).child("days").child(day).remove()
